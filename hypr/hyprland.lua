...
-- Window switching with Alt+Tab (snappy-switcher)
...
local recordBind = hl.bind(mainMod .. " + SHIFT + R",
    hl.dsp.exec_cmd("wf-recorder -f ~/Videos/recording_$(date +%Y%m%d_%H%M%S).mp4"))
-- recordBind:set_enabled(false)
hl.bind(mainMod .. " + CTRL + R", hl.dsp.exec_cmd("killall -SIGINT wf-recorder"))

-- Color picker
hl.bind(mainMod .. " + SHIFT + P", hl.dsp.exec_cmd("hyprpicker -a"))

-- Blue light filter toggle
hl.bind(mainMod .. " + SHIFT + H", hl.dsp.exec_cmd("hyprshade toggle"))
